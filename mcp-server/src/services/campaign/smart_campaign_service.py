...
from google.ads.googleads.v25.services.services.smart_campaign_suggest_service import (
    SmartCampaignSuggestServiceClient,
)
from google.ads.googleads.v25.services.types.smart_campaign_suggest_service import (
    ...
    def client(self) -> SmartCampaignSuggestServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "SmartCampaignSuggestService", version="v25"
            )
