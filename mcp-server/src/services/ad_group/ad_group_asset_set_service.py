...
from google.ads.googleads.v25.services.services.ad_group_asset_set_service import (
    AdGroupAssetSetServiceClient,
)
from google.ads.googleads.v25.services.types.ad_group_asset_set_service import (
    MutateAdGroupAssetSetsRequest,
    MutateAdGroupAssetSetsResponse,
    AdGroupAssetSetOperation,
)
from google.ads.googleads.v25.resources.types.ad_group_asset_set import (
    AdGroupAssetSet,
)
    ...
    def client(self) -> AdGroupAssetSetServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "AdGroupAssetSetService", version="v25"
            )
