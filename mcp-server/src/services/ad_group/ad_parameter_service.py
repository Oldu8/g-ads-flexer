...
from google.ads.googleads.v25.resources.types.ad_parameter import (
    AdParameter,
)
from google.ads.googleads.v25.services.services.ad_parameter_service import (
    ...
    def client(self) -> AdParameterServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "AdParameterService", version="v25"
            )
