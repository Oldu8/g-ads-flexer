...
from google.ads.googleads.v25.services.services.keyword_plan_service import (
    KeywordPlanServiceClient,
)
from google.ads.googleads.v25.services.services.keyword_plan_idea_service import (
    KeywordPlanIdeaServiceClient,
)
from google.ads.googleads.v25.services.services.keyword_plan_campaign_service import (
    KeywordPlanCampaignServiceClient,
)
from google.ads.googleads.v25.services.services.keyword_plan_ad_group_keyword_service import (
    ...
    def client(self) -> KeywordPlanServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "KeywordPlanService", version="v25"
            )
        ...
        try:
            ...
            campaign_service: KeywordPlanCampaignServiceClient = (
                sdk_client.client.get_service(
                    "KeywordPlanCampaignService", version="v25"
                )
            )
    ...
    async def add_keywords_to_plan(
        ...
        try:
            ...
            keyword_service: KeywordPlanAdGroupKeywordServiceClient = (
                sdk_client.client.get_service(
                    "KeywordPlanAdGroupKeywordService", version="v25"
                )
            )
