...
from google.ads.googleads.v25.services.services.customer_asset_service import (
...
from google.ads.googleads.v25.enums.types.asset_link_status import (
    AssetLinkStatusEnum,
)
    ...
    def client(self) -> CustomerAssetServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "CustomerAssetService", version="v25"
            )
