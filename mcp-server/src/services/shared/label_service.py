...
from google.ads.googleads.v25.services.services.label_service import (
    LabelServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.services.campaign_label_service import (
    CampaignLabelServiceClient,
)
from google.ads.googleads.v25.services.services.ad_group_label_service import (
...
class LabelService:
    ...
    def client(self) -> LabelServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service("LabelService", version="v25")
    ...
    async def apply_label_to_campaigns(
        ...
        try:
            ...
            campaign_label_service: CampaignLabelServiceClient = (
                sdk_client.client.get_service("CampaignLabelService", version="v25")
            )

            from google.ads.googleads.v25.resources.types.campaign_label import (
                CampaignLabel,
            )
    ...
    async def apply_label_to_ad_groups(
        ...
        try:
            ...
            ad_group_label_service: AdGroupLabelServiceClient = (
                sdk_client.client.get_service("AdGroupLabelService", version="v25")
            )

            from google.ads.googleads.v25.resources.types.ad_group_label import (
                AdGroupLabel,
            )
