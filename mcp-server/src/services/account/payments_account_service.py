...
from google.ads.googleads.v25.services.services.payments_account_service import (
    PaymentsAccountServiceClient,
)
from google.ads.googleads.v25.services.types.payments_account_service import (
    ...
    def client(self) -> PaymentsAccountServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "PaymentsAccountService", version="v25"
            )
