...
from google.ads.googleads.v25.services.services.identity_verification_service import (
    IdentityVerificationServiceClient,
)
from google.ads.googleads.v25.services.types.identity_verification_service import (
    ...
    def client(self) -> IdentityVerificationServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "IdentityVerificationService", version="v25"
            )
