...
from google.ads.googleads.v25.services.services.customer_client_link_service import (
    CustomerClientLinkServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.customer_client_link_service import (
    ...
    def client(self) -> CustomerClientLinkServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "CustomerClientLinkService", version="v25"
            )
