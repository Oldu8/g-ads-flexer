...
from google.ads.googleads.v25.services.services.customer_user_access_service import (
    CustomerUserAccessServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.customer_user_access_service import (
    ...
    def client(self) -> CustomerUserAccessServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "CustomerUserAccessService", version="v25"
            )
