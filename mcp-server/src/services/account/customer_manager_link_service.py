...
from google.ads.googleads.v25.services.services.customer_manager_link_service import (
    CustomerManagerLinkServiceClient,
)
from google.ads.googleads.v25.services.types.customer_manager_link_service import (
    ...
    def client(self) -> CustomerManagerLinkServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "CustomerManagerLinkService", version="v25"
            )
