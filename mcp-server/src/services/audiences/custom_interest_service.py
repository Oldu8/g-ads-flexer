...
from google.ads.googleads.v25.resources.types.custom_interest import (
    CustomInterest,
    CustomInterestMember,
)
from google.ads.googleads.v25.services.services.custom_interest_service import (
    CustomInterestServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.custom_interest_service import (
    ...
    def client(self) -> CustomInterestServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "CustomInterestService", version="v25"
            )
