...
from google.ads.googleads.v25.resources.types.custom_audience import (
    CustomAudience,
    CustomAudienceMember,
)
from google.ads.googleads.v25.services.services.custom_audience_service import (
    CustomAudienceServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.custom_audience_service import (
    ...
    def client(self) -> CustomAudienceServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "CustomAudienceService", version="v25"
            )
