...
from google.ads.googleads.v25.resources.types.account_link import (
    AccountLink,
    ThirdPartyAppAnalyticsLinkIdentifier,
)
from google.ads.googleads.v25.services.services.account_link_service import (
    AccountLinkServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.account_link_service import (
    ...
    def client(self) -> AccountLinkServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "AccountLinkService", version="v25"
            )
