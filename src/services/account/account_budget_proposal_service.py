...
from google.ads.googleads.v25.services.services.account_budget_proposal_service import (
    AccountBudgetProposalServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.account_budget_proposal_service import (
    ...
    def client(self) -> AccountBudgetProposalServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "AccountBudgetProposalService", version="v25"
            )
