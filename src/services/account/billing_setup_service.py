...
from google.ads.googleads.v25.services.services.billing_setup_service import (
    BillingSetupServiceClient,
)
from google.ads.googleads.v25.services.services.google_ads_service import (
    GoogleAdsServiceClient,
)
from google.ads.googleads.v25.services.types.billing_setup_service import (
    ...
    def client(self) -> BillingSetupServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "BillingSetupService", version="v25"
            )
