...
from google.ads.googleads.v25.services.services.brand_suggestion_service import (
    BrandSuggestionServiceClient,
)
from google.ads.googleads.v25.services.types.brand_suggestion_service import (
    ...
    def client(self) -> BrandSuggestionServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "BrandSuggestionService", version="v25"
            )
