...
from google.ads.googleads.v25.resources.types.product_link import (
    ProductLink,
    DataPartnerIdentifier,
    GoogleAdsIdentifier,
    MerchantCenterIdentifier,
)
from google.ads.googleads.v25.services.services.product_link_service import (
    ProductLinkServiceClient,
)
from google.ads.googleads.v25.services.types.product_link_service import (
    ...
    def client(self) -> ProductLinkServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "ProductLinkService", version="v25"
            )
