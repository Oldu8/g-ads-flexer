...
class AudienceInsightsService:
    ...
    def client(self) -> AudienceInsightsServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "AudienceInsightsService", version="v25"
            )
    ...
    async def generate_insights_finder_report(
        ...
        try:
            ...
            # Add gender if provided (a single gender is supported here)
            ...
            # Add user interests if provided. There is no dedicated
            # `user_interests` field on InsightsAudience; each interest is
            # wrapped as an AudienceInsightsAttribute and grouped into a
            # topic_audience_combinations entry (groups are OR'd internally,
            ...
            if specific_audience_user_interests:
                ...
                for interest_id in specific_audience_user_interests:
                    ...
                    interest_group.attributes.append(attribute)
