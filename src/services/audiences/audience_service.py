...
from google.ads.googleads.v25.services.services.audience_service import (
    ...
    def _create_audience_dimension(self, config: Dict[str, Any]) -> AudienceDimension:
        ...
        if dimension_type == "AGE":
            ...
            for age_range in age_ranges:
                ...
                from google.ads.googleads.v25.common.types.audiences import AgeSegment
