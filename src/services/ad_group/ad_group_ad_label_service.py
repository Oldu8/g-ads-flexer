...
from google.ads.googleads.v25.services.services.ad_group_ad_label_service import (
...
from google.ads.googleads.v25.resources.types.ad_group_ad_label import (
    AdGroupAdLabel,
)
    ...
    def client(self) -> AdGroupAdLabelServiceClient:
        ...
        if self._client is None:
            ...
            self._client = sdk_client.client.get_service(
                "AdGroupAdLabelService", version="v25"
            )
